...
<head>
  <meta charset="UTF-8">
  <title>HODs Login</title>
  <script type="module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.esm.js"></script>
<script nomodule src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
<link rel='stylesheet' href='https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap'><link rel="stylesheet" href="hod_css.css">

</head>
<body>
<!-- partial:index.partial.html -->
<form action="" method="POST" enctype="multipart/form-data" class="screen-1">
<!-- <div class="screen-1"> -->
  ...
  <?php
          if(isset($_SESSION['hod_login5'])){
            echo $_SESSION['hod_login5'];
            unset($_SESSION['hod_login5']);
          }
   ?>
    <div class="email">
        ...
        <input type="email" name="hod_email" placeholder="Username@gmail.com"/>
        </div>
    </div>
    <div class="password">
        ...
        <input class="pas" type="password" name="hod_password" placeholder="············"/>
        <ion-icon class="show-hide" name="eye-outline"></ion-icon>
        </div>
    </div>
    <!-- <button class="login">Login </button> -->
    <input type="submit" name ="hod_login" value="Login" class="login">
...
if(isset($_POST['hod_login'])){ 
    $email = $_POST['hod_email'];
    $password = $_POST['hod_password'];
    // $email = "dvchaudharihod@gmail.com";
    echo $email ;
    echo $password;
    // $password = "12345";
    if($email == "" || $password ==""){
        $_SESSION['hod_login5'] ="<div class='error'>Email and Password is Mandatory</div>";
        header('location:'.SITEURL.'details/hod_login.php');
    }
    else{
    ...
    if($email == "dvchaudharihod@gmail.com" and $password =="12345"){
       $_SESSION['login6'] ="<div class='submit'> User LoggedIn Successfully</div>";
       header('location:'.SITEURL.'Hods/add-student.php');
    }
    else {
      $_SESSION['hod_login5'] ="<div>Email and Password does not Match</div>";
      header('location:'.SITEURL.'details/hod_login.php');
    }
}
}
