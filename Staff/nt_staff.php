...
<body>
      <div class="container1">
       <br><br><h1 style="color:grey;">See All NTS</h1><br>
    </div><br>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <th><?php 
                                          ...
                                          ?></th>
                                    <th>
                                    <a href="<?php  echo SITEURL; ?>Staff/leave-nts.php?id=<?php echo $id; ?>" class="danger-btn">Leave</a>
